...
import com.pineslack.openapi.model.CreateCouponBase;
...
public class CouponsConfig {
    ...
    public ObjectMapper objectMapper() {
        ...
        simpleModule.addDeserializer(CreateCouponBase.class, new CouponsMapper.CustomCreateCouponDeserializer());
